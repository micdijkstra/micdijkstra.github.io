...
function startFlash(timeoutSpeed) {
  timeout = setInterval(function () {
      $('.o, .r .e.m').toggleClass('flashOn flashOff');
    }, timeoutSpeed);
}

function stopFlash() {
  clearTimeout(timeout);
  $('.o, .r .e.m').removeClass('flashOn flashOff');
}
...
$(document).ready(function() {
  ...
  $('input[name=flashspeed]').keyup(function() {
    stopFlash()
    var timeoutSpeed = $(this).val();
    if (timeoutSpeed != '') {
      startFlash($(this).val())
    }
  });
